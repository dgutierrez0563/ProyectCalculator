 ...
 * @date 2016-03-02
 */
public class AboutCalculator extends javax.swing.JDialog {
    /**
     * Creates new form AboutCalculator
     */
    public AboutCalculator(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AboutCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AboutCalculator dialog = new AboutCalculator(new javax.swing.JFrame(), true);
